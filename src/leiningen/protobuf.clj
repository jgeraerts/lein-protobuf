...
(defn protoc [project]
  (let [protoc-exe (protoc-executable)
        protoc-home (System/getenv "PROTOC_HOME")
        protoc-file (io/file protoc-home protoc-exe)]
    (if (.exists protoc-file)
      protoc-file      
      (io/file (srcdir project) "src" protoc-exe))))
